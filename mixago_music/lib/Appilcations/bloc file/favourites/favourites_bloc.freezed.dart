...
mixin _$FavouritesEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function() listchanging,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? listchanging,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$Listchanging implements Listchanging {
  const _$Listchanging();

  @override
  String toString() {
    return 'FavouritesEvent.listchanging()';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$Listchanging);
  }
...
abstract class Listchanging implements FavouritesEvent {
  const factory Listchanging() = _$Listchanging;
}
...
abstract class $FavouritesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Musics> favouritelist});
}
...
class _$_FavouritesState implements _FavouritesState {
  const _$_FavouritesState({required final List<Musics> favouritelist})
  ...
  @override
  String toString() {
    return 'FavouritesState(favouritelist: $favouritelist)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_favouritelist));
...
abstract class _FavouritesState implements FavouritesState {
  const factory _FavouritesState({required final List<Musics> favouritelist}) =
      _$_FavouritesState;
